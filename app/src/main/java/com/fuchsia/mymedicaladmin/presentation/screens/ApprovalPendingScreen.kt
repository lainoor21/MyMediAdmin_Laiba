                                    ...
                                    Column(Modifier.padding(10.dp)) {
                                        ...
                                        Switch(
                                            ...
                                            onCheckedChange = { checked ->
                                                isChecked = checked
                                                if (checked) {
                                                    viewModel.approveUser(data[it].user_id, 1)
                                                    viewModel.removeUserFromPending(data[it].user_id)
